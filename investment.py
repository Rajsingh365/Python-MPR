...
class InvestmentApp(Tk):
    def __init__(self, age, retirement_age, monthly_savings, retirement_goal):
        super().__init__()
    ...
    def show_scenario_window(self, scenario_name):
        ...
        details += "\nProbability of meeting Retirement Goal: "+str(probability)
        # print(probability)
        self.probability_label.config(text=f"Probability of meeting Retirement Goal for: "+scenario_name+"-"+str(probability))
